...
def cart():
	...
	return render_template('cart.html', title='Cart', cartRecipes = cartRecipes, input_ingredient_list = input_ingredient_list, neededIngredients = needed, usedIngredients = used)
